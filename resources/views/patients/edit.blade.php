                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('patient_type') is-invalid @enderror" 
                                    ...
                                    <option value="outpatient" {{ old('patient_type', $patient->patient_type) == 'outpatient' ? 'selected' : '' }}>خارجي</option>
                                    <option value="inpatient" {{ old('patient_type', $patient->patient_type) == 'inpatient' ? 'selected' : '' }}>داخلي</option>
                                    <option value="emergency" {{ old('patient_type', $patient->patient_type) == 'emergency' ? 'selected' : '' }}>طوارئ</option>
                                </select>
                                @error('patient_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('emergency_contact.relationship', $patient->emergency_contact['relationship'] ?? '') }}" 
                                       required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('family_head_id') is-invalid @enderror" 
                                    ...
                                    @foreach($familyHeads as $familyHead)
                                        <option value="{{ $familyHead->id }}" {{ old('family_head_id', $patient->family_head_id) == $familyHead->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('family_relation', $patient->family_relation) }}" 
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('allergies') is-invalid @enderror" 
                                          ...
                                          name="allergies" 
                                          rows="3" 
                                          placeholder="اكتب أنواع الحساسية مفصولة بفواصل">{{ old('allergies', is_array($patient->allergies) ? implode(', ', $patient->allergies) : '') }}</textarea>
                                @error('allergies')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('chronic_conditions') is-invalid @enderror" 
                                          ...
                                          rows="3" 
                                          placeholder="اكتب الأمراض المزمنة مفصولة بفواصل">{{ old('chronic_conditions', is_array($patient->chronic_conditions) ? implode(', ', $patient->chronic_conditions) : '') }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('medical_notes') is-invalid @enderror" 
                                          ...
                                          name="medical_notes" 
                                          rows="4" 
                                          placeholder="أي ملاحظات طبية إضافية">{{ old('medical_notes', $patient->medical_notes) }}</textarea>
                                @error('medical_notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
// Initialize family relation field visibility
document.addEventListener('DOMContentLoaded', function() {
    const familyHeadSelect = document.getElementById('family_head_id');
    const familyRelationField = document.getElementById('family_relation').parentElement;
    
    if (!familyHeadSelect.value) {
        familyRelationField.style.display = 'none';
        document.getElementById('family_relation').required = false;
    }
});

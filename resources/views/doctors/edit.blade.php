...
@section('page-title', 'تعديل الطبيب - ' . $doctor->full_name)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="bi bi-pencil-square text-facebook"></i>
                        تعديل بيانات الطبيب
                    </h5>
                    <div class="btn-group">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('doctors.update', $doctor) }}" enctype="multipart/form-data" id="doctorForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('national_id') is-invalid @enderror" 
                                       id="national_id" name="national_id" value="{{ old('national_id', $doctor->national_id) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                                    ...
                                    <option value="male" {{ old('gender', $doctor->user->gender) == 'male' ? 'selected' : '' }}>ذكر</option>
                                    <option value="female" {{ old('gender', $doctor->user->gender) == 'female' ? 'selected' : '' }}>أنثى</option>
                                </select>
                                @error('gender')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control @error('mobile') is-invalid @enderror" 
                                       id="mobile" name="mobile" value="{{ old('mobile', $doctor->user->mobile) }}">
                                @error('mobile')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          id="address" name="address" rows="2">{{ old('address', $doctor->user->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                                ...
                                <select class="form-select @error('department_id') is-invalid @enderror" 
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" 
                                                {{ old('department_id', $doctor->user->department_id) == $department->id ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('job_title') is-invalid @enderror" 
                                       id="job_title" name="job_title" value="{{ old('job_title', $doctor->user->job_title) }}">
                                @error('job_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('specialization') is-invalid @enderror" 
                                    ...
                                    @foreach($specializations as $key => $value)
                                        <option value="{{ $key }}" 
                                                {{ old('specialization', $doctor->specialization) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('degree') is-invalid @enderror" id="degree" name="degree" required>
                                    ...
                                    @foreach($degrees as $key => $value)
                                        <option value="{{ $key }}" 
                                                {{ old('degree', $doctor->degree) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('university') is-invalid @enderror" 
                                       id="university" name="university" value="{{ old('university', $doctor->university) }}">
                                @error('university')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('languages') is-invalid @enderror" 
                                       ...
                                       value="{{ old('languages', $doctor->languages ? implode(', ', $doctor->languages) : '') }}" 
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('sub_specializations') is-invalid @enderror" 
                                       id="sub_specializations" name="sub_specializations" 
                                       value="{{ old('sub_specializations', $doctor->sub_specializations ? implode(', ', $doctor->sub_specializations) : '') }}" 
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('biography') is-invalid @enderror" 
                                          id="biography" name="biography" rows="4" maxlength="2000">{{ old('biography', $doctor->biography) }}</textarea>
                                @error('biography')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('follow_up_fee') is-invalid @enderror" 
                                       id="follow_up_fee" name="follow_up_fee" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('room_number') is-invalid @enderror" 
                                       id="room_number" name="room_number" value="{{ old('room_number', $doctor->room_number) }}">
                                @error('room_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control @error('doctor_phone') is-invalid @enderror" 
                                       id="doctor_phone" name="doctor_phone" value="{{ old('doctor_phone', $doctor->phone) }}">
                                @error('doctor_phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('doctor_email') is-invalid @enderror" 
                                       id="doctor_email" name="doctor_email" value="{{ old('doctor_email', $doctor->email) }}">
                                @error('doctor_email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <label for="profile_photo" class="form-label">تغيير الصورة الشخصية</label>
                        ...
                        <div class="row mb-4">
                            ...
                            @foreach($days as $dayKey => $dayName)
                                @php
                                    $dayHours = $currentHours[$dayKey] ?? ['is_working' => false, 'start' => '08:00', 'end' => '16:00'];
                                @endphp
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" 
                                           name="is_active" value="1" {{ old('is_active', $doctor->is_active) ? 'checked' : '' }}>

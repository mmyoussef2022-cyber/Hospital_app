...
@section('page-title', 'تعديل الشهادة - ' . $certificate->title)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('doctors.certificates.show', [$doctor, $certificate]) }}" class="btn btn-outline-info">
                            <i class="bi bi-eye"></i>
                            عرض الشهادة
                        </a>
                ...
                <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="alert alert-light">
                                    <h6 class="alert-heading">الملف الحالي</h6>
                                    <div class="d-flex align-items-center">
                    ...
                    <form method="POST" action="{{ route('doctors.certificates.update', [$doctor, $certificate]) }}" enctype="multipart/form-data" id="certificateForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    ...
                                    @foreach($types as $key => $value)
                                        <option value="{{ $key }}" {{ old('type', $certificate->type) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control @error('institution') is-invalid @enderror" 
                                       id="institution" name="institution" value="{{ old('institution', $certificate->institution) }}" required>
                                @error('institution')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('country') is-invalid @enderror" 
                                       id="country" name="country" value="{{ old('country', $certificate->country) }}">
                                @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          id="description" name="description" rows="3" maxlength="1000">{{ old('description', $certificate->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                <label for="certificate_file" class="form-label">ملف الشهادة الجديد</label>
                                ...
                                <div class="form-text">
                                    ...
                                    <br>
                                    <strong>ملاحظة:</strong> اتركه فارغاً إذا كنت لا تريد تغيير الملف الحالي
                                </div>
                            </div>
                            ...
                            <div class="col-12" id="filePreview" style="display: none;">
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title">معاينة الملف الجديد</h6>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        ...
                                        <strong>تنبيه:</strong> هذه الشهادة مُتحقق منها. 
                                        أي تعديل سيؤدي إلى إلغاء التحقق وستحتاج إلى تحقق جديد.
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('doctors.certificates.show', [$doctor, $certificate]) }}" class="btn btn-outline-secondary">
...
document.getElementById('certificateForm').addEventListener('submit', function(e) {
    ...
    // Confirm if certificate is verified
    @if($certificate->is_verified)
        if (!confirm('هذه الشهادة مُتحقق منها. هل أنت متأكد من التعديل؟ سيتم إلغاء التحقق.')) {
            e.preventDefault();
            return false;
        }
    @endif
